...
DATABASES = {
    'default': {
        ...
        'NAME': '/var/www/stq/dev.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '=7ke%!*daa43g3g(6mf8b6sh1*iw!d*68+nz*d!m7i)1z%%4#c'
